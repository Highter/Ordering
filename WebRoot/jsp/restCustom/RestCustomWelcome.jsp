...
<link rel="stylesheet" type="text/css"
	href="<%=path%>/css/RestCustomWelcome.css">
<script type="text/javascript" src="<%=path%>/js/jquery.js"></script>
<script type="text/javascript" src="<%=path%>/js/RestCustomWelcome.js"></script>
...
<body onload="MenuLoad()">
	...
	<div id="Head">
		<div class="Head_Welcome">
			<a >尊敬的 ${custom.login_name} 餐馆用户,Welcome to CYL 订餐网</a>
		</div>
		<div id="Search">
		...
		<div id="Menu">
			<a href="/Ordering/jsp/restCustom/RestCustomInfo.jsp" id="inforCustom">个人信息</a> 
